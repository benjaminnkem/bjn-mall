  ...
  return (
    <>
      <div className="py-20 px-10 bg-stone-200 dark:bg-stone-900">
        ...
        <p className="text-sm">
          Last Seen:{" "}
          <span className="font-semibold text-stone-700 dark:text-stone-200">{new Date().toLocaleTimeString()}</span>
        </p>
      </div>
            ...
            <div className="mt-3 space-y-2">
              <div className="flex items-center space-x-4">
                ...
                <p>
                  ...
                  <span className="text-green-500 font-semibold border-b border-green-500 cursor-pointer">Davicci</span>
                </p>
              </div>
              <div className="flex items-center space-x-4">
